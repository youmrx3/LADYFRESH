...
export const ar: Dictionary = {
  ...
  packs: {
    eyebrow: "عروضنا",
    titre: "اختاري عرضك.",
    lede: "أربعة منتجات متناسقة بسعر خاص. التوصيل إلى كل الولايات، والدفع عند الاستلام.",
    vide: "العروض قريبًا.",
  ...
  admin: {
    ...
    campagne: {
      eyebrow: "Ø§ÙØ¥Ø¹ÙØ§Ù",
      titre: "ØµÙØ­Ø© Ø§ÙØ­ÙÙØ©",
      aide: "ÙØ§ ØªØ±Ø§Ù Ø§ÙØ²Ø§Ø¦Ø±Ø© Ø§ÙÙØ§Ø¯ÙØ© ÙÙ Ø¥Ø¹ÙØ§ÙØ ÙØ¨Ù Ø§ÙØ¹Ø±ÙØ¶.",
      voir: "Ø¹Ø±Ø¶ Ø§ÙØµÙØ­Ø©",
      aideTraduction:
      ...
      sansCoffret: "ÙØ§ ØªÙØ¬Ø¯ Ø¹Ø±ÙØ¶ Ø¨Ø¹Ø¯.",
      sectionBandeau: "Ø´Ø±ÙØ· Ø§ÙØ¥Ø¹ÙØ§Ù",
      bandeauAide: "Ø´Ø±ÙØ· Ø°ÙØ¨Ù ÙÙ Ø§ÙØ£Ø¹ÙÙØ ÙÙØ´ØºÙÙ ÙÙØª Ø§ÙØ¹Ø±Ø¶ ÙÙØ·.",
      bandeau: "ÙØµ Ø§ÙØ´Ø±ÙØ·",
      bandeauActif: "Ø¥Ø¸ÙØ§Ø± Ø§ÙØ´Ø±ÙØ·",
      sectionHero: "Ø§ÙØ§ÙØªØªØ§Ø­ÙØ©",
      heroAide: "Ø«Ø§ÙÙØªØ§Ù Ø¨Ø¹Ø¯ Ø§ÙÙÙØ±. ÙØµÙØ± ÙÙÙÙÙØ³ ÙØ²Ø± ÙØ§Ø­Ø¯.",
      surtitre: "Ø§ÙØ¹ÙÙØ§Ù Ø§ÙÙØ±Ø¹Ù",
      titreHero: "Ø§ÙØ¹ÙÙØ§Ù",
      titreAide: "Ø§ÙØªÙÙÙ ÙØ³Ø·Ø± Ø¬Ø¯ÙØ¯ : Ø§ÙØ³Ø·Ø± Ø§ÙØ«Ø§ÙÙ ÙØ¸ÙØ± Ø¨Ø§ÙØ°ÙØ¨Ù.",
      lede: "Ø§ÙØ¬ÙÙØ© Ø§ÙØªÙÙÙØ¯ÙØ©",
      bouton: "ÙØµ Ø§ÙØ²Ø±",
      gages: "Ø§ÙØ¶ÙØ§ÙØ§Øª",
      gagesAide: "افصلي بينها بـ « | ».",
      photo: "ØµÙØ±Ø© Ø§ÙØ§ÙØªØªØ§Ø­ÙØ©",
      photoAide: "Ø¹ÙØ¯ Ø¹Ø¯Ù Ø§Ø®ØªÙØ§Ø±ÙØ§Ø ØªÙØ³ØªØ¹ÙÙ ØµÙØ±Ø© Ø£ÙÙ Ø¹Ø±Ø¶.",
    },
    packs: {
      eyebrow: "الكتالوج",
      titre: "العروض",

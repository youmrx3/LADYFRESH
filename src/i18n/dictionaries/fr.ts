...
export const fr = {
  ...
  admin: {
    ...
    campagne: {
      ...
      bandeauAide: "Une bande dorée tout en haut. Ã allumer le temps d'une offre, Ã  Ã©teindre après.",
      ...
      surtitre: "Surtitre",
      titreHero: "Titre",
      titreAide: "Passez Ã  la ligne pour couper le titre : la seconde ligne s'affiche en doré.",
      ...
      photoAide: "Ã dÃ©faut, la photo du premier coffret est utilisée.",
    },
    packs: {
      eyebrow: "Catalogue",
      titre: "Coffrets",

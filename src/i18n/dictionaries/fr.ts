...
export const fr = {
  ...
  admin: {
    ...
    campagne: {
      ...
      aide: "Ce que voit quelqu'un qui arrive par une publicitÃ©, avant les coffrets. Le rayon et le formulaire suivent, eux, les rÃ©glages de la boutique.",
      voir: "Voir la page",
      sansCoffret: "Aucun coffret pour l'instant : la page s'ouvrira sur un rayon vide.",
      sectionBandeau: "Bandeau d'annonce",
      bandeauAide: "Une bande dorÃ©e tout en haut. Ã allumer le temps d'une offre, Ã  Ã©teindre aprÃ¨s.",
      ...
      surtitre: "Surtitre",
      titreHero: "Titre",
      titreAide: "Passez Ã  la ligne pour couper le titre : la seconde ligne s'affiche en dorÃ©.",
      lede: "Phrase d'accroche",
      bouton: "Texte du bouton",
      gages: "Garanties",
      gagesAide: "SÃ©parez-les par une barre verticale Â« | Â». Trois suffisent.",
      photo: "Photo d'ouverture",
      photoAide: "Ã dÃ©faut, la photo du premier coffret est utilisÃ©e.",
    },
    packs: {
      eyebrow: "Catalogue",
      titre: "Coffrets",

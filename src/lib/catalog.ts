...
export const SETTINGS: SiteSettings = {
  ...
  camp_bandeau_ar: "التوصيل لـ 58 ولاية — الدفع عند الاستلام",
  camp_bandeau_en: "Delivery to 58 wilayas — pay on arrival",
  camp_eyebrow: "Coffrets Lady Fresh",
  camp_eyebrow_ar: "عروض ليدي فرش",
  camp_eyebrow_en: "Lady Fresh bundles",
  camp_titre: "Quatre essentiels.\nUn seul coffret.",
  camp_titre_ar: "أربعة أساسيات.\nعرض واحد.",
  camp_titre_en: "Four essentials.\nOne bundle.",
  camp_lede:
    "Brume, gel intime et déodorants réunis à un prix pensé pour l'ensemble. Choisissez le vôtre, on vous rappelle pour confirmer.",
  camp_lede_ar:
    "بخاخ معطر وجل حميمي ومزيلات روائح في عرض واحد بسعر خاص. اختاري عرضك ونتصل بك للتأكيد.",
  camp_lede_en:
    "Mist, intimate wash and deodorants together at a price built for the set. Pick yours, we call you to confirm.",
  camp_cta: "Je choisis mon coffret",
  camp_cta_ar: "أختار عرضي",
  camp_cta_en: "Pick my bundle",
  camp_gages: "Livraison 58 wilayas|Paiement à la réception|On vous rappelle pour confirmer",
  camp_gages_ar: "التوصيل لـ 58 ولاية|الدفع عند الاستلام|نتصل بك للتأكيد",
  camp_gages_en: "Delivery to 58 wilayas|Pay on delivery|We call you to confirm",
